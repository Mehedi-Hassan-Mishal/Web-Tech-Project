...
{ 
	?>
	<label style="font-size:20px; color:green  ">Serach Here:</label>
<input style="font-size:20px " type="text" onkeyup="imu(this.value)" placeholder="Live search">

<div>
<h2 style="color:white;" class="table table-bordered" id="contant">Show here</h2>
</div>
...
function imu(x)
{
    ...
    else
    {
        ...
        xml.open('GET','../Model/search.php?q='+x,true);
        xml.send();
    }
}
