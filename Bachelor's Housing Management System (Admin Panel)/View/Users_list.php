...
<form style="font-size:25px; color:black; " action=""> 
  <select name="customers" onchange="showCustomer(this.value)">
    <option style="font-size:25px; color:black; " value="">Select a User:</option>
      <option value="Kawsar Hamid">Kawsar</option>
    <option value="Ariyan Jahangir">Ariyan</option>
    <option value="Fahmida Rashid">Fahmida</option>
    <option value="Parag Gosh">Parag</option>
       <option value="Natasha Sabiha">Natasha</option>
  </select>
</form>
<br>
<br>
